...
//  02 Slot-Machine
//
//  Created by DEEPAK SANKHYAN on 19/09/22.
//
    ...
    var body: some View {
        ZStack {
            ...
            .alert(item: $showingAlert) { alert -> Alert in
                switch alert {
                case .success:
                    return Alert(title: Text("yeag you won"), message: Text("Born with chrm"), dismissButton: .cancel())
                case .faliure:
