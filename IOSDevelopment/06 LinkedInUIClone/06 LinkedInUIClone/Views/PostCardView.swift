...
let samplePostData = PostData(id: 1, Image: "02", title: "Deepak", followers: 100, profileImage: "1")
...
struct PostCardView: View {
    ...
    var body: some View {
        VStack(alignment: .leading){
            ...
            Text("Looking for a new course in iOS with swiftUI you are already in a great place")
            Image(data.Image)
                .resizable()
                .aspectRatio( contentMode: .fit)
